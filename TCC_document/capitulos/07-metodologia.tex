...
O \textit{hardware} montado formará a plataforma física do componente, enquanto a biblioteca desenvolvida atuará no microcontrolador para disponibilizar os dados na rede.
...
\begin{figure}[htb]
    ...
    \includegraphics[width=0.70\textwidth]{figuras/arquitetura_geral.png}
