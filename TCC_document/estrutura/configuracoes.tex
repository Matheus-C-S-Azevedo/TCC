...
\titulo{DESENVOLVIMENTO DE UMA SOLUÇÃO DE SOFTWARE EM LINGUAGEM C PARA SUPORTE À IMPLEMENTAÇÃO DE \textit{ASSET ADMINISTRATION SHELL} EMBARCADOS APLICADOS À INDUSTRIA 4.0}
