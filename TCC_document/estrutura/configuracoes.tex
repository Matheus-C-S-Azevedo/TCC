...
\newcommand{\coordenador}[1]{\renewcommand{\imprimirCoordenador}{#2}}

\autor{MATHEUS COSTA SOARES DE AZEVEDO}
\titulo{DESENVOLVIMENTO DE UMA SOLUÇÃO DE \textit{SOFTWARE} EM LINGUAGEM C PARA SUPORTE À IMPLEMENTAÇÃO DE \textit{ASSET ADMINISTRATION SHELL} EMBARCADOS APLICADOS À INDÚSTRIA 4.0}
\orientador{Rubens de Andrade Fernandes, Dr.}
\avaliador{Bruno da Gama Monteiro, Me.}
\coordenador{João Evangelista Neto, Dr.}
